                        ...
                        if(!isset($_SESSION["guest"])) {
                          echo '
                            <li class="form-inline my-2 my-lg-0" style="margin-left: 20px">
                              <a class="btn btn-outline-success my-2 my-sm-0" type="submit" href="index.php?page=admin&controller=login&action=index">Login</a>
                            </li>';
                        } else {
                            ...
                            echo '
                              <li class="form-inline my-2 my-lg-0" style="margin-left: 20px">
                              <a href="index.php?page=admin&controller=login&action=logout" class="btn btn-outline-danger my-2 my-sm-0">Log out</a>
                              </li>';
                          }
                      ?>
                  </div>
